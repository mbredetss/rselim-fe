    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        ...
        <li class="dropdown">
          ...
          <ul>
            <li><a href="ugd.php" class="active">UGD</a></li>
...
<section id="tentang-kami" class="py-5">
  ...
  <div class="container mt-4">
    ...
    <p class="text-justify">
      Unit Gawat Darurat (UGD) Rumah Sakit Elim Rantepao memberikan pelayanan gawat darurat 24 jam yang siap dengan fasilitas-fasilitas penunjang yang berkualitas seperti Radiologi, Laboratorium, Farmasi dalam melakukan pelayanan gawat darurat. UGD Rumah Sakit Elim Rantepao juga menyediakan ambulans emergency dan non-emergency yang responsif berikut dengan tim yaitu dokter, perawat dan paramedik guna memudahkan transportasi pasien.
    </p>

    <!-- Gambar 1 -->
    <div class="text-center my-4">
      <img src="assets/img/ugd.png" alt="Rumah Sakit Elim Rantepao Lama" 
