          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul>
                ...
                <li><a href="homecare.php" class="active">Home Care</a></li>
...
<section id="tentang-kami" class="py-5">
  <div class="container text-center">
   ...
   <div class="page-title text-center py-4 bg-light">
      <h1 class="fw-bold">Home Care</h1>
      <hr class="mx-auto my-3" style="width: 80px; border: 2px solid #0d6efd;">
    </div>

    <!-- Homecare Section -->
    <section id="homecare" class="py-5">
      <div class="container">
        <!-- Gambar -->
        <div class="text-center mb-4">
          <img src="assets/img/ambulance.png" alt="Layanan Homecare RS Elim Rantepao"
            class="img-fluid rounded shadow" style="max-width: 800px;">
        </div>

        <!-- Deskripsi -->
        <p class="text-justify">
          Layanan Homecare menjadi salah satu layanan Unggulan Rumah Sakit Elim Rantepao. 
          Layanan ini adalah layanan yang memberikan asuhan perawatan di tempat tinggal pasien 
          dalam meningkatkan, mempertahankan, atau memulihkan kesehatan dan meminimalkan dampak penyakit. 
          Dengan layanan ini pasien akan dimudahkan mendapatkan perawatan tanpa dirawat di rumah sakit dengan biaya yang terjangkau.
        </p>

        <!-- List -->
    <!-- Judul tetap tengah -->
<p class="fw-bold text-center">
  Biaya tergantung kebutuhan pasien, secara umum terdiri dari:
</p>
