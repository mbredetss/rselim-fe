          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="Poliklinikparu.php" class="active">Poliklinik Paru</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Penyakit Dalam</h1>
...
<div class="row align-items-center mb-5">
  <div class="col-md-4 text-center">
    <img src="assets/img/pd1.png" alt="dr. Jerry Koluku, Sp.PD" 
         class="img-fluid rounded shadow doctor-img">
  </div>
  <div class="col-md-8 text-start">
    <h4 class="fw-bold">dr. Jerry Koluku, Sp.PD</h4>
    <p class="mb-2"><strong>Jadwal :</strong><br>
      Selasa & Jumat : Pukul 11.00 – 14.00 WITA
    </p>
...
<div class="row align-items-center mb-5">
  <div class="col-md-4 text-center">
    <img src="assets/img/pd2.png" alt="dr. Noverio S. Tarukallo, Sp.PD" 
         class="img-fluid rounded shadow doctor-img">
  </div>
  <div class="col-md-8 text-start">
    <h4 class="fw-bold">dr. Noverio S. Tarukallo, Sp.PD</h4>
    <p class="mb-2"><strong>Jadwal :</strong><br>
      Senin, Rabu, Kamis : Pukul 14.15 – 17.00 WITA<br>
    </p>
    <p class="mb-2"><strong>Layanan:</strong><br>
      Konsultasi<br>
    </p>
...
<div class="row align-items-center mb-5">
  <div class="col-md-4 text-center">
    <img src="assets/img/pd3.png" alt="dr. Altius Rangan Paratte, Sp.PD" 
         class="img-fluid rounded shadow doctor-img">
  </div>
  <div class="col-md-8 text-start">
    <h4 class="fw-bold">dr. Altius Rangan Paratte, Sp.PD</h4>
    <p class="mb-2"><strong>Jadwal :</strong><br>
      Senin, Rabu, Kamis, Sabtu: Pukul 08.00 – 12.00 WITA<br>
    </p>
    <p class="mb-2"><strong>Layanan:</strong><br>
      Konsultasi<br>
    </p>
