          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="Poliklinikmata.php" class="active">Poliklinik Mata</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Mata</h1>
...
<div class="container">
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/pmata.png" alt="dr. Budhi Karoma, Sp.M class="img-fluid rounded shadow">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. Budhi Karoma, Sp.M</h4>
      <p class="mb-2"><strong>Jadwal :</strong><br>
        Senin – Jumat : Pukul 08.00 – 13.00 WITA
        Sabtu : Pukul 08.00-12.00 WITA
      </p>
      <p class="mb-2"><strong>Layanan:</strong><br>
        Konsultasi<br>
Pemeriksaan visus<br>
Pengukuran kacamata dengan refraktometri<br>
Pemeriksaan tonometri digital (tekanan bola mata)<br>
Pemeriksaan biometri dan keratometri<br>
Pemeriksaan funduskopi (saraf mata)<br>
Pemeriksaan buta warna<br>
Pemeriksaan segmen anterior mata dengan slit lamp<br>
      </p>
    </div>
  </div>
    </div>
