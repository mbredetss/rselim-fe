          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="PoliklinikOrthopaedidantraumatologi.php" class="active">Poliklinik Orthopaedi & Traumatologi</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Orthopaedi dan Traumatologi</h1>
...
<div class="container">
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/trauma.png" alt="dr. Raymond Parrung, Sp.OT">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. Raymond Parrung, Sp.OT</h4>
      <p class="mb-2"><strong>Jadwal :</strong><br>
        Senin & Kamis : Pukul 08.00 – 12.00 WITA
        Rabu : Pukul 15.00-17.00 WITA
      </p>
