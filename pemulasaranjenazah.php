          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul>
                ...
                <li><a href="pemulasaranjenazah.php" class="active">Pemulasaran Jenazah</a></li>
              </ul>
            </li>
...
<section id="tentang-kami" class="py-5">
  <div class="container text-center">
    <!-- Judul -->
    <h1 class="m-0 fw-bold">Pemulasaran Jenazah</h1>
  ...
  <div class="container mt-4">
    ...
    <p class="text-justify">
     Instalasi Pemulasaran Jenazah Rumah Sakit Elim Rantepao adalah tempat perawatan jenazah baik jenazah dari dalam maupun luar rumah sakit. Prosedur perawatan jenazah dilakukan sesuai dengan agama yang dianut oleh jenazah atau sesuai dengan permintaan keluarga pasien. Layanan yang ada di instalasi Pemulasaran Jenazah meliputi penitipan jenazah sementara, memandikan pasien, pengawetan jenazah, pendoa jenazah dan ruang duka.
    </p>

    <!-- Gambar 1 -->
    <div class="text-center my-4">
      <img src="assets/img/jenazah.png" alt="Rumah Sakit Elim Rantepao Lama" 
