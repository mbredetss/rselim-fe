          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="Polikliniktht.php" class="active">Poliklinik THT</a></li>
              </ul>
            </li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik THT</h1>
...
<div class="container">
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/tht.png" alt="dr. A. Tjandra Manukbua, Sp.THT, KL">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. A. Tjandra Manukbua, Sp.THT, KL</h4>
      <p class="mb-2"><strong>Jadwal :</strong><br>
        Selasa, Kamis, Sabtu : Pukul 09.30 – 11.30 WITA<br>
      </p>
