        ...
        <li class="dropdown">
          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul>
                <li><a href="arrang.php" class="active">Arrang Beauty & Wellness Center</a></li>
...
<main id="main">
    ...
    <!-- ======= Hero Section ======= -->
    <section class="d-flex align-items-center justify-content-center text-center" style="min-height: 80vh; padding-top:100px;">
      <div class="container">
        <h1 class="fw-bold">Feryal Arrang Aesthetic Clinic</h1>
        <hr class="mx-auto my-3" style="width: 100px; border: 2px solid #0d6efd;">
        <a href="https://wa.me/6281356530130" target="_blank" class="btn btn-primary btn-lg mt-4">
