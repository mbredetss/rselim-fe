  ...
  <img src="assets/img/LAFKI.png" alt="Logo RS 2" class="me-2">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        ...
        <li><a href="mutu.php" class="active">Mutu</a></li>
...
<!-- end header-->
<!-- Grafik Mutu Section -->
<section id="grafik-mutu" class="py-5">
  <div class="container text-center" style="margin-top: 100px;">
    <!-- Judul -->
    <h1 class="m-0 fw-bold">Grafik Mutu</h1>
    <p class="m-0 fw-semibold text-muted">Indikator Mutu Rumah Sakit</p>
  ...
  <div class="container mt-4">
    ...
    <div class="text-center mb-5">
      <img src="assets/img/mutu1.png" alt="Grafik Mutu 1"
           class="img-fluid rounded shadow" style="max-width: 750px;">
    </div>
    <!-- Gambar 2 -->
    <div class="text-center mb-5">
      <img src="assets/img/mutu2.png" alt="Grafik Mutu 2"
           class="img-fluid rounded shadow" style="max-width: 750px;">
    </div>
    <!-- Gambar 3 -->
    <div class="text-center mb-5">
      <img src="assets/img/mutu3.png" alt="Grafik Mutu 3"
           class="img-fluid rounded shadow" style="max-width: 750px;">
    </div>
    <!-- Gambar 4 -->
    <div class="text-center mb-5">
      <img src="assets/img/mutu4.png" alt="Grafik Mutu 4"
           class="img-fluid rounded shadow" style="max-width: 750px;">
    </div>
    <!-- Gambar 5 -->
    <div class="text-center mb-5">
      <img src="assets/img/mutu5.png" alt="Grafik Mutu 5"
           class="img-fluid rounded shadow" style="max-width: 750px;">
    </div>
    <!-- Gambar 6 -->
    <div class="text-center mb-5">
      <img src="assets/img/mutu6.png" alt="Grafik Mutu 6"
           class="img-fluid rounded shadow" style="max-width: 750px;">
    </div>
  </div>
</section>
