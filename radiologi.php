          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul>
                ...
                <li><a href="radiologi.php" class="active">Radiologi</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Dokter Radiologi</h1>
...
<div class="container">
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/radio1.png" alt="Dr. Yosefina Rempe’, Sp.Rad" class="img-fluid rounded shadow">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">Dr. Yosefina Rempe’, Sp.Rad</h4>
      <p class="mb-2"><strong>Jadwal :</strong><br>
        Senin, Selasa, Kamis, Sabtu : Pukul 08.00 – 10.00 WITA
      </p>
    </div>
  </div>
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/.png" alt="dr. Orpa Seri, Sp. Rad" class="img-fluid rounded shadow">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. Orpa Seri, Sp. Rad</h4>
      <p class="mb-2"><strong>Jadwal :</strong><br>
        Rabu & Jumat : Pukul 14.00 – 16.00 WITA   
    </p>
    </div>
  </div>
</div>
