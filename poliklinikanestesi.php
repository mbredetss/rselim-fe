          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="Poliklinikanestesi.php" class="active">Poliklinik Anestesi</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Anestesi</h1>
...
<div class="row align-items-center mb-5">
  <div class="col-md-4 text-center">
    <img src="assets/img/anestesi.png" 
         alt="dr. Rudi Andilolo" 
         class="img-fluid rounded shadow"
         style="max-width: 450px; height: auto;">
  </div>
  <div class="col-md-8 text-start">
    <h4 class="fw-bold">dr. Rudi Andilolo, Sp.An</h4>
    <p class="mb-2"><strong>Jadwal :</strong><br>
      Senin – Sabtu : Pukul 08.00 – 12.00 WITA
    </p>
