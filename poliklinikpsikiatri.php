          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="Poliklinikpenyakitdalam.php" class="active">Poliklinik Penyakit Dalam</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Psikiatri</h1>
...
<div class="container">
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/jiwa.png" alt="dr. Kristanty Randa Arung, SpKJ., M.Kes">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. Kristanty Randa Arung, SpKJ., M.Kes</h4>
      <p class="mb-2"><strong>Jadwal :</strong><br>
        Rabu & Kamis : Pukul 13.00 – 16.00 WITA<br>
        Jumat : Pukul 12.00 - 15.00 WITA
      </p>
