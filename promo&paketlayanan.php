  ...
  <img src="assets/img/LAFKI.png" alt="Logo RS 2" class="me-2">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul>
                ...
                <li><a href="ruangkelas3.php">Ruang Kelas 3</a></li></ul>   
            ...
            <li class="dropdown">
              ...
              <ul>
                ...
                <li><a href="rehabilitasmedi.php">Rehabilitasi Medik</a></li>
        ...
        <li><a href="promo&paketlayanan.php" class="active">Promo & Paket Layanan</a></li>
      </ul>
...
<section id="grafik-mutu" class="d-flex align-items-center py-5" style="min-height: 100vh;">
  <div class="container text-center">
    <!-- Judul -->
    <h1 class="m-0 fw-bold">Promo dan Paket Layanan</h1>
    <hr class="mx-auto my-3" style="width: 100px; border: 2px solid #0d6efd;">
    ...
    <div class="row g-4 justify-content-center mt-4">
      ...
      <div class="col-lg-3 col-md-4">
        <div class="card h-100 shadow-sm">
          <a href="#" data-bs-toggle="modal" data-bs-target="#promo1Modal">
            <img src="assets/img/promo1.png" class="card-img-top" alt="Promo Skin Booster">
          </a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-4">
        <div class="card h-100 shadow-sm">
          <a href="#" data-bs-toggle="modal" data-bs-target="#promo2Modal">
            <img src="assets/img/promo2.png" class="card-img-top" alt="Promo Merdeka 20%">
          </a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-4">
        <div class="card h-100 shadow-sm">
          <a href="#" data-bs-toggle="modal" data-bs-target="#promo3Modal">
            <img src="assets/img/promo3.png" class="card-img-top" alt="Promo Merdeka 10%">
          </a>
        </div>
      </div>
...
<!-- Modal Promo 1 -->
<div class="modal fade" id="promo1Modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <img src="assets/img/promo1.png" class="img-fluid" alt="Promo Skin Booster">
    </div>
  </div>
</div>

<!-- Modal Promo 2 -->
<div class="modal fade" id="promo2Modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <img src="assets/img/promo2.png" class="img-fluid" alt="Promo Merdeka 20%">
    </div>
  </div>
</div>

<!-- Modal Promo 3 -->
<div class="modal fade" id="promo3Modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <img src="assets/img/promo3.png" class="img-fluid" alt="Promo Merdeka 10%">
    </div>
  </div>
</div>
...
<div class="mb-5" data-aos="fade-up" data-aos-delay="200" style="margin-top:30px;">
  <iframe 
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.4442678921523!2d119.89675249999999!3d-2.9741357!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2d93e9e5b4eedad5%3A0x689db9cb474b5412!2sRS%20Elim%20Rantepao!5e0!3m2!1sid!2sid!4v1755838858113!5m2!1sid!2sid" 
    width="100%" 
    height="350" 
    style="border:0;" 
    allowfullscreen="" 
...
<!-- /Emergency Info Section -->
  ...
  <footer id="footer" class="footer position-relative light-background">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Rs Elim Rantepao</strong> 
      <div class="credits">
