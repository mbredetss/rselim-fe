            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="Poliklinikjantungdanpembuluhdarah.php">Poliklinik Jantung & Pembuluh Darah</a></li>
                 <li><a href="Poliklinikkulitdankelamin.php" class="active">Poliklinik Kulit dan Kelamin</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Kulit dan Kelamin</h1>
...
<div class="container">
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/kelamin.png" alt="dr. Evangelina Lumban Gaol" class="img-fluid rounded shadow">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. Evangelina Lumban Gaol, Sp.DV</h4>
