          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul>
                ...
                <li><a href="laboratorium.php"  class="active">Laboratorium</a></li>
...
<section id="tentang-kami" class="py-5">
  <div class="container text-center">
    <!-- Judul -->
    <h1 class="m-0 fw-bold">Laboratorium</h1>
  ...
  <div class="container mt-4">
    ...
    <p class="text-justify">
     Alat pemeriksaan Laboratorium Rumah Sakit Elim Rantepao sudah dilengkapi dengan Laboratory Information System (LIS) yang telah terintegrasi dengan Sistem Informasi Manajemen Rumah Sakit (SIMRS) yang dimiliki oleh Rumah Sakit Elim Rantepao. Sistem yang terintegrasi ini sangat memudahkan diagnosis, sehingga para dokter bisa menanganinya dengan cepat dan akurat dan juga meningkatan mutu Rumah Sakit Elim Rantepao demi kenyamanan pasien.
    </p>

    <!-- Gambar 1 -->
    <div class="text-center my-4">
      <img src="assets/img/labo.png" alt="Rumah Sakit Elim Rantepao Lama" 
