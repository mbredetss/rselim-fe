          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="Poliklinikgizi.php" class="active">Poliklinik Gizi</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Gizi</h1>
...
<div class="container">
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/gizi1.png" alt="dr. Wilma Dian Marannu Toding" class="img-fluid rounded shadow">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. Wilma Dian Marannu Toding, Sp.GK, M.Kes</h4>
      <p class="mb-2"><strong>Jadwal :</strong><br>
        Senin – Jumat : Pukul 14.15 – 15.00 WITA
      </p>
