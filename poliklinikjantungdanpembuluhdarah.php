          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="Poliklinikjantungdanpembuluhdarah.php" class="active">Poliklinik Jantung & Pembuluh Darah</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Jantung dan Pembuluh Darah</h1>
...
<div class="container">
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/pembuluhdara.png" alt="dr. Yoshua Iskandar, Sp.JP" class="img-fluid rounded shadow">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. Yoshua Iskandar, Sp.JP., FIHA</h4>
      <p class="mb-2"><strong>Jadwal :</strong><br>
        Senin – Jumat : Pukul 08.30 – 10.30 WITA
      </p>
      <p class="mb-2"><strong>Executive :</strong><br>
