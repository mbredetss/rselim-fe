          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="Poliklinikobgyn.php" class="active">Poliklinik Obgyn</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Obgyn</h1>
...
<div class="row align-items-center mb-5">
  <div class="col-md-4 text-center">
    <img src="assets/img/obg1.png" alt="dr. Welly Hosea, Sp.OG" 
         class="img-fluid rounded shadow doctor-img">
  </div>
  <div class="col-md-8 text-start">
    <h4 class="fw-bold">dr. Welly Hosea, Sp.OG</h4>
    <p class="mb-2"><strong>Jadwal :</strong><br>
      Sabtu, Rabu, Kamis : Pukul 08.00 – 12.00 WITA<br>
    </p>
...
<div class="row align-items-center mb-5">
  <div class="col-md-4 text-center">
    <img src="assets/img/obg2.png" alt="dr. Jerisatrio S. Tarukallo, Sp.OG" 
         class="img-fluid rounded shadow doctor-img">
  </div>
  <div class="col-md-8 text-start">
    <h4 class="fw-bold">dr. Jerisatrio S. Tarukallo, Sp.OG</h4>
    <p class="mb-2"><strong>Jadwal :</strong><br>
      Selasa, Jumat : Pukul 14.15 – 17.00 WITA<br>
    </p>
    <p class="mb-2"><strong>Layanan:</strong><br>
      Konsultasi<br>
    </p>
...
<div class="row align-items-center mb-5">
  <div class="col-md-4 text-center">
    <img src="assets/img/obg3.png" alt="dr. Septian Sima, Sp.OG" 
         class="img-fluid rounded shadow doctor-img">
  </div>
  <div class="col-md-8 text-start">
    <h4 class="fw-bold">dr. Septian Sima, Sp.OG</h4>
    <p class="mb-2"><strong>Jadwal :</strong><br>
      Senin – Jumat: Pukul 12.00 – 15.00 WITA<br>
      Sabtu : Pukul 08.00 – 12.00 WITA<br>
    </p>
    <p class="mb-2"><strong>Layanan:</strong><br>
      Konsultasi<br>
    </p>
