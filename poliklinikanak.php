          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul style="max-height:300px; overflow-y:auto;">
                ...
                <li><a href="poliklinikanak.php" class="active">Poliklinik Anak</a></li>
...
<div class="container text-center my-5" style="padding-top: 120px;">
  <h1 class="fw-bold mb-3">Poliklinik Anak</h1>
...
<div class="container">
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/anak1.png" alt="dr. Prarindra Khrisanti" class="img-fluid rounded shadow">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. Prarindra Khrisanti, Sp.A</h4>
  ...
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center">
      <img src="assets/img/anak2.png" alt="dr. Gabriela Angel Mustakim" class="img-fluid rounded shadow">
    </div>
    <div class="col-md-8 text-start">
      <h4 class="fw-bold">dr. Gabriela Angel Mustakim, Sp.A</h4>
      <p class="mb-2"><strong>Jadwal :</strong><br>
        Senin – Kamis : Pukul 12.00 – 15.00 WITA<br>
        Jumat – Sabtu : Pukul 09.00 – 12.00 WITA
      </p>
      <p class="mb-2"><strong>Layanan:</strong><br>
        Konsultasi<br>
        Skrining Stunting<br>
        Vaksinasi<br>
        Nebulizer
      </p>
    </div>
