...
<?php
$url = 'http://localhost:1337/api/poliklinik-umums?populate[dokter][populate]=*';
...
<body class="index-page">
            ...
            <ul>
              ...
              <li class="dropdown">
                ...
                <ul style="max-height:300px; overflow-y:auto;">
                  <li><a href="poliklinikumum.php" class="active">Poliklinik Umum</a></li>
    ...
    <div class="page-title">
      ...
      <section id="tentang-kami" class="py-5">
        <div class="container text-center">
          <!-- Judul -->
          <h1 class="m-0 fw-bold">Poliklinik Umum</h1>
  ...
  <!-- Tombol WhatsApp -->
  <a href="https://wa.me/6282190959393" class="whatsapp-float btn btn-success d-flex align-items-center"
    target="_blank">
